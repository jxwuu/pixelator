...
public:
    ...
    */
   PNG render();
   void renderHelp(PNG &png, Node* subroot); 
    ...
    */
   void prune(int tol);
   void pruneHelp(int tol, Node* subroot); 
   ...
   int pruneSizeHelp(Node* subroot, int tol);
